...
function generateReport(items) {
  return items?.map(item => {
    ...
    item.transferERC20Amounts.length > 0 ? output.transferERC20Amounts = item.transferERC20Amounts.map(tea=>{tea.amountString = utils.formatEther(BigNumber.from(tea.amountString)); return tea}) : null;
    item.changeERC20Amounts.length > 0 ? output.changeERC20Amounts = item.changeERC20Amounts.map(tea=>{tea.amountString = utils.formatEther(BigNumber.from(tea.amountString)); return tea}) : null;
    item.receiveERC20Amounts.length > 0 ? output.receiveERC20Amounts = item.receiveERC20Amounts.map(tea=>{tea.amountString = utils.formatEther(BigNumber.from(tea.amountString)); return tea}) : null;
    item.unshieldERC20Amounts.length > 0 ? output.unshieldERC20Amounts = item.unshieldERC20Amounts.map(tea=>{tea.amountString = utils.formatEther(BigNumber.from(tea.amountString)); return tea}) : null;
    item.receiveNFTAmounts.length > 0 ? output.receiveNFTAmounts = item.receiveNFTAmounts.map(tea=>{tea.amountString = utils.formatEther(BigNumber.from(tea.amountString)); return tea}) : null;
    item.transferNFTAmounts.length > 0 ? output.transferNFTAmounts = item.transferNFTAmounts.map(tea=>{tea.amountString = utils.formatEther(BigNumber.from(tea.amountString)); return tea}) : null;
    item.unshieldNFTAmounts.length > 0 ? output.unshieldNFTAmounts = item.unshieldNFTAmounts.map(tea=>{tea.amountString = utils.formatEther(BigNumber.from(tea.amountString)); return tea}) : null;
